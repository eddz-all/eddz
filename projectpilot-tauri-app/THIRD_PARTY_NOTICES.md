...
ProjectPilot uses `@gitkraken/gitkraken-components` for the Git Workspace commit graph. The component package is distributed by GitKraken under the following license text.
