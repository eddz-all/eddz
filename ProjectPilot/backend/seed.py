...
def seed_data():
    ...
    try:
        ...
        if server_a is None:
            ...
            server_a.connection_mode = "local"
        ...
        bindings = [
            (project_pilot, server_a, str(PROJECT_ROOT)),
        ...
        for project, server, project_path in bindings:
            ...
            elif existing_binding.project_path != project_path:
                existing_binding.project_path = project_path
        ...
        print("")
        print("Test data:")
        print(f"- ProjectPilot project_id: {project_pilot.id}")
        print(f"- DemoApp project_id: {demo_app.id}")
        print(f"- server-a server_id: {server_a.id}")
        print(f"- server-b server_id: {server_b.id}")
        print("")
        print("Recommended AI test URLs:")
        print(f"- POST /projects/{project_pilot.id}/ai/analyze-env")
        print(f"- POST /projects/{project_pilot.id}/ai/config-plan")
        print(
            f"- GET /projects/{project_pilot.id}/servers/{server_a.id}/env-snapshots/latest"
        )
        print(
            f"- GET /projects/{project_pilot.id}/servers/{server_b.id}/env-snapshots/latest"
        )
    finally:
        db.close()
